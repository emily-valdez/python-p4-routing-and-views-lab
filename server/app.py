...
#A print_string view should take one parameter, a string. It should print the string in the terminal and display it in the web browser. Its URL should be of the format /print/parameter.
